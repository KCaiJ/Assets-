	...
	<div class="page-container">
		<div class="text-c">
			<form class="form form-horizontal" id="form" method="post"
				action="${pageContext.request.contextPath}/books/getName.do">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;"
				onclick="batchdel('${pageContext.request.contextPath}/books/batchDelete.do')"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除 </a> 
			<a href="javascript:;"
				onclick="insert('添加','${pageContext.request.contextPath}/books/add.do','800','400')"
				class="btn btn-primary radius"> <i class="Hui-iconfont">&#xe600;</i>
					添加
			</a> 
			<a href="javascript:;"
				onclick="insert('添加','${pageContext.request.contextPath}/books/import.do','800','400')"
				class="btn btn-primary radius"> <i class="Hui-iconfont">&#xe645;</i>
					导入数据
			</a> 
			<a href="${pageContext.request.contextPath}/books/export.do?string=booksData"
				class="btn btn-primary radius"> <i class="Hui-iconfont">&#xe644;</i>
					数据导出
			</a> 
			</span>
				...
				<c:forEach items="${requestScope.records }" var="record">
					<tr class="text-c">
						...
						<td class="td-manage"><a title="编辑" href="javascript:;"
							onclick="update('编辑','${pageContext.request.contextPath}/books/get.do?id=${record.did }','1','800','500')"
							...
							<c:if test="${record.status  ==1||record.status==3}">
								<a title="删除"
							href="javascript:;"
							onclick="del(this,'${pageContext.request.contextPath}/books/del.do?id=${record.did}')"
							class="ml-5" style="text-decoration: none"><i
								class="Hui-iconfont">&#xe6e2;</i></a>
							</c:if>
							...
							<c:if test="${record.status  ==1}">
								<a title="出库"
								href="javascript:;"
								onclick="update('出库','${pageContext.request.contextPath}/books/out.do?id=${record.did }','1','700','400')"
								class="ml-5" style="text-decoration: none"><i
								class="Hui-iconfont">&#xe634;</i></a>
							</c:if>
