...
<body>
	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
		<a href="javascript:;"
				onclick="batchdel('${pageContext.request.contextPath}/devicereceive/batchDelete.do','删除')"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除 </a>	
		<a href="javascript:;"
				onclick="insert('添加','${pageContext.request.contextPath}/devicereceive/add.do','800','500')"
				...
				<c:forEach items="${requestScope.records }" var="record">
					<tr class="text-c">
						...
						<td class="td-manage">
							...
							onclick="update('归还','${pageContext.request.contextPath}/devicereceive/return.do?id=${record.id }','1','800','500')"
							class="ml-5" style="text-decoration: none"><i
							   ...
							   <c:otherwise>
							    <a title="删除"
									href="javascript:;"
									onclick="del(this,'${pageContext.request.contextPath}/devicereceive/del.do?id=${record.id}')"
