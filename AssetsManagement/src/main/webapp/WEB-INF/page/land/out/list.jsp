	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
					...
					<a href="javascript:;"
				onclick="batchdel('${pageContext.request.contextPath}/landout/updatebatch_To.do','通过')"
				class="btn btn-primary radius"> <i class="Hui-iconfont">&#xe6e1;</i>
					批量通过 </a> 
					<a href="javascript:;"
				onclick="batchdel('${pageContext.request.contextPath}/landout/updatebatch_No.do','拒绝')"
				...
				<c:forEach items="${requestScope.records }" var="record">
					<tr class="text-c">
						...
						<td class="td-manage">
							...
							onclick="update('通过','${pageContext.request.contextPath}/landout/out_To.do?id=${record.id }','1','800','500')"
							class="ml-5" style="text-decoration: none"><i
								class="Hui-iconfont">&#xe6e1;</i></a> 
							<a title="拒绝" href="javascript:;"
							onclick="update('拒绝','${pageContext.request.contextPath}/landout/out_No.do?id=${record.id }','1','800','500')"
							class="ml-5" style="text-decoration: none"><i
								class="Hui-iconfont">&#xe6dd;</i></a> 
